...
| boolean  | [changeDir](#changeDir(java.lang.String))(String pathName) 切换工作目录 |
| -------- | ------------------------------------------------------------ |
| boolean  | [changeToHomeDir](#changeToHomeDir())() 切换到根目录         |
| boolean  | [changeToParentDir](#changeToParentDir())() 切换到上一级目录 |
| String   | [currentDir](#currentDir())() 当前工作目录                   |
| boolean  | [delDir](#delDir(java.lang.String))(String dirName) 删除文件夹 |
| boolean  | [delFile](#delFile(java.lang.String))(String fileName) 删除文件 |
| boolean  | [downloadFile](#downloadFile(java.lang.String, java.lang.String, java.lang.String))(String remotePath, String fileName,String localPath) 下载文件 |
| boolean  | [exist](#exist(java.lang.String))(String name) 当前目录是否存在文件或文件夹 |
| boolean  | [exist](#exist(java.lang.String, java.lang.String))(String path, String name) 指定目录下，是否存在文件或文件夹 |
| boolean  | [existDir](#existDir(java.lang.String))(String name) 当前目录是否存在文件夹 |
| boolean  | [existDir](#existDir(java.lang.String, java.lang.String))(String path, String name) 指定目录下，是否存在文件夹 |
| boolean  | [existFile](#existFile(java.lang.String))(String name) 当前目录是否存在文件 |
| boolean  | [existFile](#existFile(java.lang.String, java.lang.String))(String path, String name) 指定目录下，是否存在文件 |
| boolean  | [login](#login())() 登陆SFTP服务器                           |
| void     | [logout](#logout())() 登出                                   |
| String[] | [ls](#ls())() 当前目录下文件及文件夹名称列表                 |
| String[] | [ls](#ls(java.lang.String))(String pathName) 指定目录下文件及文件夹名称列表 |
| String[] | [lsDirs](#lsDirs())() 当前目录下文件夹名称列表               |
| String[] | [lsDirs](#lsDirs(java.lang.String))(String pathName) 指定目录下文件夹名称列表 |
| String[] | [lsFiles](#lsFiles())() 当前目录下文件名称列表               |
| String[] | [lsFiles](#lsFiles(java.lang.String))(String pathName) 指定目录下文件名称列表 |
| boolean  | [makeDir](#makeDir(java.lang.String))(String dirName) 创建目录 |
| boolean  | [uploadFile](#uploadFile(java.lang.String, java.lang.String, java.io.InputStream))(String pathName,String fileName,InputStream input) 上传文件 |
| boolean  | [uploadFile](#uploadFile(java.lang.String, java.lang.String, java.lang.String))(String pathName, String fileName, String localFile) 上传文件 |
...
public class Sftp {
    ...
    private Logger logger = Logger.getLogger(Sftp.class);//日志记录器
    private Session session = null;//Session
    private ChannelSftp channel = null;//Channel
